...
class NetworkUtils:
    ...
    def parse_cidr(
        ...
        Args:
        - address: 字符串，指定的网络地址，可以是IPv4或IPv6格式。
        - prefix: 整数，网络的前缀长度。
    ...
    def ip_in_range(
        ...
        *,
        ...
        示例:
        - ip_in_range("192.168.1.10", "192.168.1.0/24")
        - ip_in_range("192.168.1.10", "192.168.1.1-192.168.1.20")
        - ip_in_range("192.168.1.10", src_ip="192.168.1.1", dst_ip="192.168.1.20")

        - ip_in_range("2a00::110:1", "2a00::110:0/116")
        - ip_in_range("2a00::110:1", "2a00::110:1-2a00::110:fff")
        """
