...
def test_6():
    assert DateLib.difference_time_two(
        "2022-01-01 10:00:00", "2022-01-01 12:00:00") == 7200
    assert DateLib.difference_time_two(
        "2022-01-01 10:00:00", "2022-01-01 12:00:00", True) == -7200


def test_7():
    now_time = datetime.datetime.now()
    now_time = now_time - datetime.timedelta(minutes=int(60))
    assert DateLib.date_before_minutes(
        60) == now_time.strftime('%Y-%m-%d %H:%M:%S')


def test_8():
    now_time = datetime.datetime.now()
    now_time = now_time - datetime.timedelta(hours=int(24))
    assert DateLib.date_before_hours(
        24) == now_time.strftime('%Y-%m-%d %H:%M:%S')


def test_9():
    today = datetime.datetime.now()
    offset = datetime.timedelta(days=-7)
    assert DateLib.date_before_days(7) == (today + offset).strftime(
        '%Y-%m-%d %H:%M:%S')
...
def test_10():
    ...
    assert DateLib.time_handler(
        "2022-01-01T12:00:00.000Z") == local_time.strftime('%Y-%m-%d %H:%M:%S')
...
def test_11():
    ...
    assert DateLib.http_header_time_to_str(
        "Sat, 01 Jan 2022 12:00:00 GMT") == parsed_date.strftime('%Y-%m-%d %H:%M:%S')
...
def test_12():
    ...
    timestamp_tuple = int(start_of_day.timestamp()
...
def test_14():
    start = datetime.datetime.strptime(
        "2023-01-01 07:08:16", "%Y-%m-%d %H:%M:%S")
    end = datetime.datetime.strptime(
        "2023-01-10 07:08:16", "%Y-%m-%d %H:%M:%S")
